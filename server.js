...
http.createServer(function (req, res) {
  ...
  if (pathname == '/') {
    ...
    return;
  } else if (m = pathname.match(/^\/(js|css|dist)\//)) {
    ...
    res.write(util.format(svgTemplate, TILE_WIDTH, TILE_HEIGHT, m[1]));
    res.end();
    return;
  }
...
console.log('Mosaic server is now running at http://localhost:8765');
